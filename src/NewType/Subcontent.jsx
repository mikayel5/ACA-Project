...
class Subcontent extends Component {
    ...
    ChangeArtist = (ev, name) => {
        this.setState({inputValueAfterChange: name})
    }
    // componentDidUpdate(prevProps) {
    //     if(this.state.inputValue != this.state.inputValueAfterChange && this.state.inputValueAfterChange !== "") {
    ...
    render() {
        ...
        return (
            ...
            {inputValueAfterChange !== '' && activecontent === 'artist' && <SerachByArtist inputValueAfterChange={inputValueAfterChange} ChangeArtist={this.ChangeArtist}/>}    
